...
const viewModeSchema = z.enum(["now-playing", "lyrics", "split", "ambient"]);
...
export const settingsPatchSchema = z.object({
  ...
  || patch.lyricFollowMode !== undefined || patch.ambient !== undefined);
...
export class SettingsStore {
  ...
  async init(): Promise<void> {
    ...
    const stored = storedSettingsSchema.parse(JSON.parse(content));
